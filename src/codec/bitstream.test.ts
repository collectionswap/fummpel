...
import { BitStreamReader, BitStreamWriter, bitWidth, randomUintN } from './bitstream';
...
test('BitStreamWriter writes bits', _ => {
  ...
  assert.is(writer.dump().substr(18, 45), '00000010 10110000 00000000 00000000 01100000 ');
